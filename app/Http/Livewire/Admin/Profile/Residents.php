...
class Residents extends Component
{
    ...
    public function render()
    {
        ...
        //     ->select('families.id', 'families.head_fname', 'families.head_mname', 'families.head_lname', 'families.head_sname', 'families.head_zone', 'families.head_bday', 'families.head_bplace', 'families.head_contact')
        //     ->where('head_fname', 'like', '%' . $this->search . '%')
