...
class BrgyClearance extends Component
{
    ...
    public function release()
    {
        ...
        $this->closeModal();
        return redirect()->route('admin.docs.brgy-clearances')->with('success', 'Document successfully released');
    }
    ...
    public function forPickup()
    {
        ...
        $this->dispatchBrowserEvent('close-modal');
        return redirect()->route('admin.docs.brgy-clearances')->with('success', 'Document updated successfully');
    }
