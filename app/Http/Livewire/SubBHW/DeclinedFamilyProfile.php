...
class DeclinedFamilyProfile extends Component
{
    ...
    {
        $onlineDeclinedFamilies = FamilyHead::where('zone', auth()->guard('bhw')->user()->assigned_zone)
            ->where('user_id', '!=', null)
        ...
        return view('livewire.sub-b-h-w.declined-family-profile', ['onlineDeclinedFamilies' => $onlineDeclinedFamilies]);
    }
}
