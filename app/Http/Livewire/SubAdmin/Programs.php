...
class Programs extends Component
{
    ...
    public function add()
    {
        ...
        // $original_file_name = $this->display_image->getClientOriginalName();
        // $display_img_filename = time() . Hash::make($original_file_name) . $this->display_image->getClientOriginalExtension();

        // $this->display_image->storeAs('public/images/profiles/programs', $display_img_filename);
    ...
    public function render()
    {
        ...
        return view('livewire.sub-admin.programs', ['programs' => $programs]);
    }
}
