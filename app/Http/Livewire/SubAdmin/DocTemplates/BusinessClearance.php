...
class BusinessClearance extends Component
{
    ...
    public function release()
    {
        ...
        $this->closeModal();
        return redirect()->route('sub-admin.docs.biz-clearances')->with('success', 'Document successfully released');
    }
    ...
    public function forPickup()
    {
        ...
        $this->dispatchBrowserEvent('close-modal');
        return redirect()->route('sub-admin.docs.biz-clearances')->with('success', 'Document updated successfully');
    }
    ...
    public function render()
    {
        ...
        return view('livewire.sub-admin.doc-templates.business-clearance', [
