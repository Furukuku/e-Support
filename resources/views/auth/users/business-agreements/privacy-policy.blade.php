  ...
  <div>
    <div class="bg-white px-5 py-3 shadow-sm privacy-header">
      ...
      <div class="mb-2">
        ...
        <p class="text-center m-0">Last updated October 14, 2023</p>
      </div>
    ...
    <div class="bg-light">
      <div class="container-sm py-5">
        ...
        <p>Questions or concerns? Reading this privacy notice will help you understand your privacy rights and choices, if you do not agree with our policies and practices, please do not use our Services, if you still have any questions or concern, please contact us at nancayasancounsil@gmail.com</p>
        <h5>SUMMARY OF KEY POINTS</h5>
        <p><i>This summary provides key points from our privacy notice, but you can find out more details about any of these topics below.</i></p>
        ...
        <p>Do we process any sensitive personal information? We do not process sensitive information.</p>
        ...
        <div id="first-info" class="border-bottom border-start border-end overflow-hidden mb-4 dropdown-info">
          <p class="fw-bold">Business information you disclose to us</p>
          <p>In Short: We collect business information that you provide to us.</p>
          <p>We collect business information that you voluntarily provide to us when you register on the Services, express an interest in obtaining information about us or our products and Services, when you participate in activities on the Services, or otherwise when you contact us.</p>
          <p>Business Information Provided by You. The business information that we collect depends on the context of your interactions with us and the Services, the choices you make, and the products and features you use. The business information we collect may include the following:</p>
          <ul>
            <li>names</li>
            <li>business names</li>
            <li>nature of businesses</li>
            ...
            <li>username</li>
            <li>passwords</li>
            <li>documents (business clearances/DTI's)</li>
          </ul>
          <p>All business information that you provide to us must be true, complete, and accurate, and you must notify us of any changes to such personal information.</p>
        ...
        <div id="third-info" class="border-bottom border-start border-end overflow-hidden mb-4 dropdown-info">
          ...
          <ul>
            <li>When we use Google Maps Platform API. We may share your information with certain Google Maps platform APIs (e.g., Google Maps API, Place API). We obtain and store on your device “cache” your location. You may revoke your consent anytime by contacting us at the contacting us at the contact details provided at the end of this document.</li>
          </ul>
        </div>
        ...
        <div id="sixth-info" class="border-bottom border-start border-end overflow-hidden mb-4 dropdown-info">
          <p>In short: We do not knowingly collect data from or market to children under 15 years of age.</p>
          <p>We do not knowingly solicit data from or market to children under 15 years of age. By using the Services, you represent that you are at least 15 or that you are the parent or guardian of such a minor and consent to such minor dependent's use of the Services. If we learn that personal information from users less than 15 years of age has been collected, we will deactivate the account and take reasonable measures to promptly delete such data from our records. If you become aware of any data, we may have collected from children under age 15, please contact us at nancayasancounsil@gmail.com.</p>
        </div>
        ...
        <div id="seventh-info" class="border-bottom border-start border-end overflow-hidden mb-4 dropdown-info">
          ...
          <p>If you have questions or comments about your privacy rights, you may email us at nancayasancounsil@gmail.com.</p>
        </div>
        ...
        <div id="tenth-info" class="border-bottom border-start border-end overflow-hidden mb-4 dropdown-info">
          <p>If you have questions or comments about this notice, you may email us at nancayasancounsil@gmail.com or contact us by post at:</p>
          <p class="m-0">Barangay Nancayasan Urdaneta City</p>
          <p class="m-0">Zone 4</p>
          <p class="m-0">Nancayasan Urdaneta, Pangasinan 2428 Philippines</p>
          <p>Mobile No. 0917-580-1155</p>
        </div>
