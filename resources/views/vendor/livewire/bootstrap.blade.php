<div>
    @if ($paginator->hasPages())
        ...
        <nav class="d-flex flex-row justify-content-between align-items-center">
            <div>
                <p class="">
                    <span style="font-size: 0.85rem;" class="text-secondary">{!! __('Showing') !!}</span>
                    <span style="font-size: 0.85rem;" class="text-secondary fw-semibold">{{ $paginator->firstItem() }}</span>
                    <span style="font-size: 0.85rem;" class="text-secondary">{!! __('to') !!}</span>
                    <span style="font-size: 0.85rem;" class="text-secondary fw-semibold">{{ $paginator->lastItem() }}</span>
                    <span style="font-size: 0.85rem;" class="text-secondary">{!! __('of') !!}</span>
                    <span style="font-size: 0.85rem;" class="text-secondary fw-semibold">{{ $paginator->total() }}</span>
                    <span style="font-size: 0.85rem;" class="text-secondary">{!! __('results') !!}</span>
                </p>
            </div>
