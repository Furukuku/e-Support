    ...
    <header class="border pt-1 px-2">
      ...
      <div class="d-flex justify-content-center mb-5">
        <div class="position-relative">
          ...
          <h3 class="m-0 text-center fw-semibold serif">BARANGAY CLEARANCE</h3>
        </div>
      </div>
        ...
        <tbody>
          @forelse ($clearances as $index => $clearance)
            <tr>
              ...
              <td class="p-1 text-center align-middle text-break">{{ $clearance->brgyClearance->name }}</td>
              <td class="p-1 text-center align-middle text-break">{{ $clearance->brgyClearance->purpose }}</td>
              <td class="p-1 text-center align-middle text-break">{{ date('Y-m-d', strtotime($clearance->brgyClearance->date_issued)) }}</td>
            </tr>
          @empty
            <tr>
              <td colspan="6" class="text-center">No barangay clearances to show.</td>
            </tr>
          @endforelse
        </tbody>
      </table>
