...
{{-- Restore Modal --}}
<form wire:submit.prevent="restoreProgram">
  @csrf
  <div wire:ignore.self class="modal fade" id="restoreProgram" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="restoreProgramLabel" aria-hidden="true">
...
<form wire:submit.prevent="permanentlyDel">
  @csrf
  <div wire:ignore.self class="modal fade" id="deleteProgram" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="deleteProgramLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header border-0 pb-0 justify-content-end">
          <span class="material-symbols-outlined modal-close-icon" data-bs-dismiss="modal" wire:click="closeModal" aria-label="Close">
        ...
        <div class="modal-body pt-0">
          ...
          <h5 class="text-center">Are you sure you want to delete this program?</h5>
          <p class="text-center">This will delete the program permanently. You cannot undo this action.</p>
        </div>
        <div class="modal-footer d-flex justify-content-center border-0">
          <button type="button" class="btn btn-secondary px-4 mx-3" wire:click="closeModal" data-bs-dismiss="modal">Cancel</button>
