...
<form wire:submit.prevent="restoreTag">
  @csrf
  <div wire:ignore.self class="modal fade" id="restoreTag" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="restoreTagLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body pt-0">
          ...
          <h4 class="text-center mb-3">Restore Tag?</h4>
          <p class="text-center">Are you sure you want to restore this tag?</p>
        </div>
