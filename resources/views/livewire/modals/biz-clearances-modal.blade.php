        ...
        @if (!is_null($doc_id))
          <div class="p-2">
            ...
            <div class="border rounded p-2">
              <p class="m-0 text-truncate">{{ $biz_name }}</p>
            </div>
          </div>
          <div class="p-2">
            <p class="m-0">Business Address</p>
            <div class="border rounded p-2">
              <p class="m-0 text-truncate">{{ $biz_address }}</p>
            </div>
          </div>
          <div class="p-2">
            <p class="m-0">Nature of Business</p>
            <div class="border rounded p-2">
              <p class="m-0 text-truncate">{{ $biz_nature }}</p>
            </div>
          </div>
          <div class="p-2">
            <p class="m-0">Name of Owner</p>
            <div class="border rounded p-2">
              <p class="m-0 text-truncate">{{ $biz_owner }}</p>
            </div>
          </div>
          <div class="p-2">
