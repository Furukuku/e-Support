...
{{-- Restore Modal --}}
<form wire:submit.prevent="restoreFamily">
  @csrf
  <div wire:ignore.self class="modal fade" id="restoreFamily" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="restoreFamilyLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body pt-0">
          ...
          <h4 class="text-center mb-3">Restore Family?</h4>
          <p class="text-center">Are you sure you want to restore this family?</p>
        </div>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body pt-0">
          ...
          <h5 class="text-center">Are you sure you want to delete this family?</h5>
          <p class="text-center">This will delete the family permanently. You cannot undo this action.</p>
        </div>
        <div class="modal-footer d-flex justify-content-center border-0">
          <button type="button" class="btn btn-secondary px-4 mx-3" wire:click="closeModal" data-bs-dismiss="modal">Cancel</button>
