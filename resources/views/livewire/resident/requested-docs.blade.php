<div class="mx-5 mb-4 home-end request-list">
  ...
  <div class="d-flex justify-content-center mt-4">
    ...
    <div wire:click="pickup" class="d-flex align-items-center px-3 py-2 border-bottom requested-docs-tabs {{ $docs_tab === 'pickup' ? 'border border-bottom-0 rounded-top' : '' }}">
      <p class="m-0 text-center {{ $docs_tab === 'pickup' ? 'fw-semibold' : '' }}">Ready To Pickup</p>
    </div>
