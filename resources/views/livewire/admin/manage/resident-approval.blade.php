<div class="d-flex flex-column align-items-center py-5">
  ...
  <div class="w-100 d-flex justify-content-center">
    @include('livewire.modals.users-approval-residents-modals')
            ...
            @forelse ($residents as $resident)
              <tr>
                ...
                <td class="align-middle text-center">
                  ...
                  <span class="material-symbols-outlined align-middle search-icon" wire:loading.class="pe-none" wire:click="showVerification({{ $resident->id }})" data-bs-toggle="modal" data-bs-target="#showVerification">
                    quick_reference_all
                  </span>
