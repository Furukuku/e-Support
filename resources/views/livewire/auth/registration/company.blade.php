      ...
      <div class="col px-5 mt-2">
        ...
        @elseif ($currentPage === 2)
          <div class="col">
            ...
            <div class="row">
              <div class="col-6 mb-3">
                <label class="input-labels" for="company-zone">Business Address</label>
                <select  wire:model="business_address" id="company-zone" class="form-select">
        ...
        @elseif ($currentPage === 3)
          <div class="col">
            ...
            <div class="row-auto mb-3">
              <label class="input-labels" for="company-password">Password</label>
        ...
        {{-- @elseif ($currentPage === 4)
          <div class="col px-5">
            <div class="row mb-3">
              ...
              <div class="col-6 mb-3">
                <input wire:model.defer="verification" id="company-verification" placeholder="Enter verification code" type="text" class="form-control">
